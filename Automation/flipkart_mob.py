...
products = []
prices = []
driver.get("https://www.flipkart.com/search?q=Mobile%20%20phone&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off")
...
df.to_excel("C:\\Users\\Dell\\OneDrive\\Desktop\\Mobile_list.xlsx", index=False, encoding="UTF-8")
